...
export const Header = (props: HeaderProps): React.ReactElement => {
    ...
    return (
        <nav className="navbar">
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", padding: "1rem" }}>
                ...
                {loggedIn && <button onClick={handleLogout} className="button is-small">Log Out</button>}
                {!loggedIn && <form onSubmit={login}>
                        <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "flex-end" }}>
                            ...
                            <input className="input is-small"
                                ...
                                value={password} />
                            <button className="button is-small" type="submit">Login</button>
                        </div>
                    </form>
                }
            </div>
