...
export class Init1572866436693 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "quick_link" ("id" character varying NOT NULL, "name" character varying NOT NULL, "url" character varying NOT NULL, "dateCreated" TIMESTAMP NOT NULL DEFAULT now(), "children" text, CONSTRAINT "PK_b4369bfcbacd8ba240a3246aca4" PRIMARY KEY ("id"))`);
